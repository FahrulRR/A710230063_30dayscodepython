...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Create QPushButton widgets for the mathematical operations
        ...
        self.exponent_button = QPushButton('Pangkat')
        ...
        self.exponent_button.clicked.connect(self.exponent_numbers)
        ...
        layout.addWidget(self.exponent_button)
